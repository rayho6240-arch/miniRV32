...
#
# Script generated by Vivado on Wed Apr 29 20:58:09 +0800 2026
...
#
# Usage        : clk_wiz_2.sh
#                clk_wiz_2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk_wiz_2.sh [-rerun]
#                clk_wiz_2.sh [-reset_run]
#                clk_wiz_2.sh [-clean]
#                clk_wiz_2.sh [-reset_log]
#                clk_wiz_2.sh [-help]
#
...
export RDI_DATADIR="D:/Applications/AMD_Vivado/2025.2/Vivado/data"
...
# script info
echo -e "clk_wiz_2.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk_wiz_2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_wiz_2 xil_defaultlib.clk_wiz_2 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Applications/AMD_Vivado/2025.2/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clk_wiz_2.wdb xsim.dir libdpi.so)
...
Usage: clk_wiz_2.sh [-step]\n\
Usage: clk_wiz_2.sh [-lib_map_path]\n\
Usage: clk_wiz_2.sh [-rerun]\n\
Usage: clk_wiz_2.sh [-reset_run]\n\
Usage: clk_wiz_2.sh [-clean]\n\
Usage: clk_wiz_2.sh [-reset_log]\n\
Usage: clk_wiz_2.sh [-keep_index]\n\
