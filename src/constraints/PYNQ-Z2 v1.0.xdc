...
set_property -dict { PACKAGE_PIN H16   IOSTANDARD LVCMOS33 } [get_ports { clk_in125 }]; #IO_L13P_T2_MRCC_35 Sch=sysclk
create_clock -add -name sys_clk_pin -period 8.00 -waveform {0 4} [get_ports { clk_in125 }];
...
##set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { locked }]; #IO_L22N_T3_AD7N_35 Sch=led4_b
##set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { modeLed[1] }]; #IO_L16P_T2_35 Sch=led4_g
##set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { modeLed[3]}]; #IO_L21P_T3_DQS_AD14P_35 Sch=led4_r
#set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { led5_b }]; #IO_0_35 Sch=led5_b
##set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { modeLed[0]}]; #IO_L22P_T3_AD7P_35 Sch=led5_g
##set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { modeLed[2] }]; #IO_L23N_T3_35 Sch=led5_r
...
#set_property -dict { PACKAGE_PIN R19   IOSTANDARD LVCMOS33 } [get_ports { HDMI_HSYNC }]; #IO_0_34 Sch=hdmi_tx_hpdn
#=========================
