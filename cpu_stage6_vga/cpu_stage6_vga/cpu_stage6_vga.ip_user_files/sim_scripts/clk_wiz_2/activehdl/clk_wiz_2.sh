...
#                script (type 'clk_wiz_2.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Programing/VerilogProject/miniRV32/cpu_stage6_vga/cpu_stage6_vga/cpu_stage6_vga.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
